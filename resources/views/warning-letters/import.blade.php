...
<head>
  ...
  <title>Import Surat Peringatan</title>
  <style>
    ...
    <div class="content">
      <div class="card">
        ...
        <div class="info">
          ...
          Pastikan file Excel (.xlsx) memiliki kolom sesuai template: Nama, Jabatan, Departemen, SP Level (1/2/3), Alasan, Nomor Surat, Tanggal Surat.
          <br>
          <a href="{{ route('warning-letters.template') }}" style="color:#0c4a6e; text-decoration:underline;">📄 Download Template Excel</a>
        </div>

        <form method="POST" action="{{ route('warning-letters.import') }}" enctype="multipart/form-data">
          @csrf
          ...
          <div>
            ...
            <a href="{{ route('warning-letters.index') }}" class="btn btn-cancel" style="text-decoration:none;">Batal</a>
          </div>
        </form>
        ...
        <div style="margin-top:24px; padding:16px; background:#fef08a; border-radius:6px; border-left:3px solid #713f12;">
          ...
          <ul style="margin:8px 0 0 0; color:#713f12; font-size:13px;">
            ...
            <li>Kolom: Nama, Jabatan, Departemen, SP Level (1/2/3), Alasan, Nomor Surat, Tanggal Surat (YYYY-MM-DD)</li>
            <li>Kolom Nama wajib diisi</li>
            <li>SP Level harus angka 1, 2, atau 3</li>
          </ul>
        </div>
      </div>
    </div>
